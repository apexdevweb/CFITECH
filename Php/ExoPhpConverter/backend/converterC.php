<?php
require("converterCScript.php");
if (isset($_POST['switcher'])) {
    $legend = "Pounds" . " " . "<i class='fa-solid fa-arrow-right'></i>" . " " . "Euros";
} else {
    $legend = "Euros" . " " . "<i class='fa-solid fa-arrow-right'></i>" . " " . "Pounds";
}
?>
